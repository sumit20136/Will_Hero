...
public class NewGameController implements Initializable
{
    ...
    static int kcoins;
    static int kpoints;
    static double kOrc1X;
    static double kOrc2X;
    static double kOrc3X;
    static double kOrc4X;
    static double kOrc5X;
    static double kHeroX;
    static double kheroY;
    static int ksteps;
    static double kLayoutX;
    static int kmode;
            ...
            if(hero.getSpeedx()<=hero.getMax_speed())
            {
                ...
                if(heroImage.getBoundsInParent().intersects(coinChest1.getBoundsInParent()) && check_chest==false)
                {
                    ...
                    System.out.println("Hello");
                        check_chest=true;
//                    CoinChest1.chestOpenAnimation(coinChest1);
//                    CoinChest1.setOpened(true);
                    coins+=3;
                    coinLabel.setText(""+coins);
//                   heroImage.setImage((new Image("")));
//                    heroImage.imageProperty().set(new Image("resources/com/example/ap_final_project_72/images/hero_with_weapon.png"));
                }
    ...
    public void gameOver() throws IOException {
        ...
        kmode=mode;
        kpoints=points;
        System.out.println("Player layout at game over:"+heroImage.getLayoutX());
        System.out.println("Points after game over:"+points);
        System.out.println("coins after game over:"+coins);
        System.out.println("dynamic pane layout after game over:"+dynamicPane.getLayoutX());
        kOrc1X=orcImage1.getLayoutX();
        kOrc2X=orcImage2.getLayoutX();
        kOrc3X=orcImage3.getLayoutX();
        kOrc4X=orcImage4.getLayoutX();
        kOrc5X=orcImage5.getLayoutX();
        kheroY=heroImage.getLayoutY();
        ksteps=steps;
        kLayoutX=dynamicPane.getLayoutX();
