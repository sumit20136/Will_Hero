...
public class LoadingScreenToNewGameController implements Initializable {
    ...
    public void playGame(ActionEvent event) throws IOException {
        root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("ModeSelection.fxml")));
